...
(custom-set-variables
 ...
 '(safe-local-variable-values
   '((eval setq org-download-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/用 virtualenvwrapper 来管理 Python 虚拟环境/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/STM32H7 ADC + DMA + Timer Firmware Tutorial/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/使用 color-rg-replace-all-matches 出现 Text is read only/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/Python 2-pickle/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/Python 2-re/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/十二指肠溃疡/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/如何查找 Python 标准库代码位置/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/Python 3 LRU/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/为 tab-bar 设置快捷键时和 Spacemacs 默认配置冲突/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/MacOS 10.15 安装 paddle/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/STM32 最大采样率 最小采样率/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/pdf-info--tq-workaround 函数打印错误 Error while processing tq callback: Wrong type argument: listp, t/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/FreeRTOS API Reference/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/Python 2 使用描述符实现实例属性的检查/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/anki-open-org-note/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/Setting up SDL2 in macOS(Xcode or CMake)/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/编译 pdf-tools 时，brew 无法下载 poppler-data-0.4.12.tar.gz 而编译失败/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/OV7670 原理图/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/将文件复制到 xcode 模拟器 iCloud 文件夹/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/安装 swiftformat command line tool/"))
     (eval setq org-media-note-screenshot-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/位带操作/"))
     (eval and buffer-file-name
           ...
           (package-recipe-mode))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/使用 document-contents-extractor 提取目录/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/A list of assoc list 转换成 a vector of plist/"))
     (eval setq org-media-note-screenshot-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/undefined reference to FreeRTOS 的函数/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/CMake/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/lsp-bridge 在嵌套的 Git 项目下不能正常识别/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/Python 3 concurrency/"))
     (eval setq org-media-note-screenshot-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/修改 el-easydraw 源代码，使得 svg 内嵌图片资源路径不使用相对路径，在 Emacs、本地预览中正常显示/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/EAF image-occlusion/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/使用 org-protocol 实现 Anki 回跳至 pdf-tools/"))
     (eval setq org-media-note-screenshot-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/MacOS 配置 lvgl 模拟器/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/软链接/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/LVGL/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/MacOS 配置 STM32 开发环境/"))
     (eval setq org-media-note-screenshot-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/curl 命令示例/"))
     (eval setq org-media-note-screenshot-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/LoDkV5/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/org-gtd-tasks/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/inbox/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/工程安全健康状态管理（Management Engineering Safety Health，MESH）/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/禁用 APP Nap/"))
     (eval setq org-download-image-dir
     ...
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/Mac 数据绘图软件/"))
     (eval setq org-download-image-dir
     ...
     (eval setq org-download-image-dir
           (concat default-directory "./static//Users/c/Downloads/mx-wc/Randomize a list in Emacs/"))
     (eval setq org-media-note-screenshot-image-dir
           (concat default-directory "./static/EAF PR-Popweb dict search select/"))
     (eval setq org-download-image-dir
           (concat default-directory "./static//Users/c/Downloads/mx-wc/CORS Error Connecting to Anki Or How to Stop and Think First/"))
     (eval setq org-media-note-screenshot-image-dir
